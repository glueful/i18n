...
namespace Glueful\Extensions\I18n\Tests\Integration\Schema;
...
final class SchemaVerifierBehaviorTest extends TestCase
{
    ...
    private I18nSchemaVerifier $verifier;
    private string $dbPath;

    protected function setUp(): void
    {
        $this->dbPath = sys_get_temp_dir() . '/i18n-verify-' . uniqid('', true) . '.sqlite';
        ...
        $this->verifier = new I18nSchemaVerifier();
    }
