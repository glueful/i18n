...
namespace Glueful\Extensions\I18n\Tests\Unit\Schema;

use Glueful\Extensions\I18n\Schema\I18nSchemaVerifier;
...
final class SchemaManifestTest extends TestCase
{
    ...
    public function testVerifierClassConformsToTheManifestContract(): void
    {
        ...
        self::assertSame('glueful/i18n', (new $class())->source());
    }

    public function testVerifierCoversEveryRecursivelyDiscoveredMigration(): void
    {
        $mapped = (new I18nSchemaVerifier())->migrationBasenames();
    ...
    {
        $g = $this->manifest();
        $candidates = ['glueful/i18n' => new \Glueful\Extensions\ExtensionCandidate(
            name: 'glueful/i18n',
            provider: $g['provider'],
        ...
        self::assertSame([], $result->errors, 'i18n must resolve enabled-alone');
    }
